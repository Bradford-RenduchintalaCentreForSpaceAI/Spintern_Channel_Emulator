def Get_orbital(line_1,line_2,lat,long,height,start_elv, acc = 100):
    """
    ...
    return [time_till_window,date_at_start],[time_till_end_of_window,date_at_end], elv,d,time_window, Az
